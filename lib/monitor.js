 ...
 * cycle. Also resets the expiry count.
 *
 * @method clear
 */
...
/**
 * Resets the current expiry count, without cancelling any existing monitoring
 * cycle. Invoking this method when a cycle is in progress may result in the
 * value being changed as soon as the cycle completes.
 *
 * @method resetExpiryCount
 */
Monitor.prototype.resetExpiryCount = function() {
    this._expiryCount = 0;
}
