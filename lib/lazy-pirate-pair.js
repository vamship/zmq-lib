 ...
 *                 socket.
 */
function LazyPiratePair(endpoint, monitor, options, socketOptions) {
...
_util.inherits(LazyPiratePair, _events.EventEmitter);

/**
 * @method _initialize
 * @private
 */
LazyPiratePair.prototype._initialize = function(sendEvent) {
    var promise = null;
    if(this._isServer) {
 ...
 * @private
 */
LazyPiratePair.prototype._dispose = function() {
 ...
 * @private
 */
LazyPiratePair.prototype._send = function(message) {
 ...
 * @method initialize
 */
LazyPiratePair.prototype.initialize = function() {
 ...
 *                              peer.
 */
LazyPiratePair.prototype.send = function(message) {
 ...
 */
LazyPiratePair.prototype.acknowledge = function(messageId) {
    if (this._socketManager.socket === null) {
        throw new Error('Socket not initialized. Cannot send message');
    }
 ...
 * @method dispose
 */
LazyPiratePair.prototype.dispose = function() {
    this._dispose();
};

module.exports = LazyPiratePair;
